...
function render_scene(clearColors, rects, resource_bars, circles)
    clear_current_scene()
...
-- This function is called via NLua from C# when GameEngine starts:
function initGame()
    setup_command_queue()
    return render_scene()
end
...
-- This function is used for tests (namely render_sample_scene rather)
return {
