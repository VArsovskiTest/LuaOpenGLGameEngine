...
function monster.update(dt, self_id)
    ...
    local player_pos = Engine.GetPlayerPosition() -- C# function
    local my_pos = Engine.GetEntityPosition(self_id) -- C# function
    local distance_to_player = Engine.GetDistance(my_pos, player_pos) -- C# function
