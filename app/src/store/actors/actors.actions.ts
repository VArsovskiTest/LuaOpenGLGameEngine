...
export const updateActor = createAction('[Scene Editor] Update Actor', props<{ id: string, actorUpdate: Update<Actor> }>());
export const updateAll = createAction('[Scene Editor] Update All Actors', props<{ actorUpdates: Update<Actor>[] }>());
